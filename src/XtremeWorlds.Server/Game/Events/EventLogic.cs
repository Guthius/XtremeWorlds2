...
namespace XtremeWorlds.Server.Game.Events;
                ...
                foreach (var eventPage in relevantPages)
                {
                        ...
                        page >= 0 && page < Data.Map[mapNum].Event[id].Pages.Length)
                    {
                        ...
                        if (IsEventVisible(ref playerEventPage))
                        {
                            ...
                            if (mapEventPage.ChkHasItem == 1 && Objects.Player.HasItem(i, mapEventPage.HasItemIndex) == 0)
                            {
            ...
            if (Data.TempPlayer[i].EventMap.EventPages != null)
            {
                ...
                for (int x = 0; x < eventPagesList.Count; x++)
                {
                    ...
                    for (int z = 0; z < Data.Map[mapNum].Event[id].PageCount; z++)
                    {
                        ...
                        if (page.ChkHasItem == 1 && Objects.Player.HasItem(i, page.HasItemIndex) == 0)
                        {
                            spawnEvent = false;
                        }
                                ...
                                switch (command.Index)
                                {
                                    ...
                                    case (byte) EventCommand.ConditionalBranch:
                                    {
                                        ...
                                        switch (branch.Condition)
                                        {
                                            ...
                                            case 2: // Item
                                                conditionMet = Objects.Player.HasItem(i, branch.Data1) >= branch.Data2;
                                                break;
                                            case 3: // Class
                                    ...
                                    case (byte) EventCommand.ChangeItems:
                                    {
                                        ...
                                        {
                                            case 0: // Set
                                                if (Objects.Player.HasItem(i, command.Data1) > 0)
                                                {
                                                    SetPlayerInvValue(i, Objects.Player.FindItemSlot(i, command.Data1), command.Data3);
                                                }

                                                break;
                                            case 1: // Give
                                                Objects.Player.GiveInv(i, command.Data1, command.Data3, true);
                                                break;
                                            case 2: // Take
                                            {
                                                int itemAmount = Objects.Player.HasItem(i, command.Data1);
                                                if (itemAmount >= command.Data3)
                                                {
                                                    Objects.Player.TakeInv(i, command.Data1, command.Data3);
                                                }
                                    ...
                                    case (byte) EventCommand.WarpPlayer:
                                    {
                                        ...
                                        Objects.Player.PlayerWarp(i, command.Data1, command.Data2, command.Data3, dir);
                                        break;
                                    }
    ...
    public static void SpawnMapEventsFor(int index, int mapNum)
    {
        ...
        for (int i = 0; i < Data.Map[mapNum].EventCount; i++)
        {
            ...
            for (int z = 0; z < Data.Map[mapNum].Event[i].PageCount; z++)
            {
                ...
                if (page.ChkHasItem == 1 && Objects.Player.HasItem(index, page.HasItemIndex) == 0)
                {
                    spawnCurrentEvent = false;
                }

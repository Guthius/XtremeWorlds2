...
namespace XtremeWorlds.Client.Features.Systems;
...
public class Event
{
    ...
    //                             var textPreview = Strings.Mid(TmpEvent.Pages[CurPageNum].CommandList[curlist].Commands[i].Text1, 1, 20);
    //                             var colorStr = Convert.ToString(GetColorString(TmpEvent.Pages[CurPageNum].CommandList[curlist].Commands[i].Data1));
    //                             string chatType;
    ...
    //                         {
    //                             var variableValue = Variables[TmpEvent.Pages[CurPageNum].CommandList[curlist].Commands[i].Data1];
    //                             if (variableValue == "")
    //                                 variableValue = ": None";
    //                             else
    ...
    //                         {
    //                             var switchValue = Variables[TmpEvent.Pages[CurPageNum].CommandList[curlist].Commands[i].Data1];
    //                             if (switchValue == "")
    //                                 switchValue = ": None";
    //                             else
    ...
    public static void Packet_SpawnEvent(ReadOnlyMemory<byte> data)
    {
        ...
        for (var i = 0; i < GameState.CurrentEvents; i++)
        {
            id = buffer.ReadInt32();

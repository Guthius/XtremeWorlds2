...
public static class Npc
{
    ...
    public static void ProcessMovement(int index, int pixelsPerTick)
    {
        ...
        (var dx, var dy) = GetDirectionDelta(npc.Dir, Math.Max(1, pixelsPerTick));
        ...
        var maxXpx = Math.Max(0, (Data.MyMap.MaxX - 1) * TileSize);
        var maxYpx = Math.Max(0, (Data.MyMap.MaxY - 1) * TileSize);
